  ...
  return (
    <div className="w-[260px] md:w-3/6 h-[90px] md:h-[100px]  bg-pink-700 rounded-xl">
      ...
      <div className="w-full flex items-center">
        ...
        <h4 className='relative top-1 left-[4.7rem] pl-1 md:pl-0 md:left-[11.1rem] md:text-[18px] text-[10px] font-semibold text-stone-50 w-40'>Next-In : <span className='w-10 md:text-[18px] text-[10px] font-semibold text-stone-50 bg-black bg-opacity-55 rounded p-[5px] pt-[1.5px] pb-[1.5px]'>{Timeutc}</span> </h4>
      </div>
      </div>
